      ...
      <AnimatePresence initial={false}>
        {isExpanded && (
          ...
          >
            ...
            {/* Log list (independently scrollable) */}
            <div className="px-4 py-2 max-h-[35vh] lg:max-h-[50vh] overflow-y-auto overscroll-contain border-t border-gray-50 dark:border-white/[0.05]">
              {logLoading ? (
